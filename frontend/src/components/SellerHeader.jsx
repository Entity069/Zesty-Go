...
const SellerHeader = ({ onToggleSidebar }) => {
  ...
  const getPageTitle = () => {
    const pathTitleMap = {
      ...
      "/seller/add-items": "Add Items",
      "/seller/manage-items": "Manage Items",
      "/my-profile": "Profile"
    }

    return pathTitleMap[location.pathname] || "Seller Panel"
  }
  ...
  return (
    <header className="d-flex align-items-center justify-content-between p-4 border-bottom">
      ...
      <div className="flex-grow-1 mx-4">
        <h2 className="mb-0 text-center">{getPageTitle()}</h2>
      </div>
