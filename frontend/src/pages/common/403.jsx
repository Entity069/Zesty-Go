        ...
        <div className="auth-content p-4 p-md-5">
          <div className="auth-form">
            <div className="mb-4 text-center">
              <div className="mb-3">
                <i className="fas fa-circle-xmark text-danger" style={{ fontSize: "4rem" }}></i>
              </div>
              <h2 className="fw-bold mb-2">Access Denied</h2>
              <p className="text-muted">You don't have any permission to view this page.</p>
            </div>
            <div className="d-grid gap-2">
              <Button variant="primary" onClick={handleGoHome} className="fw-semibold">
                <i className="fas fa-home me-2"></i>Go Home
              </Button>
              <Button variant="outline-secondary" onClick={handleGoBack} className="fw-semibold">
